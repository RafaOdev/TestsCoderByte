function FirstFactorial(num){
    let numFac = 1; // Variável que começará com valor de 1, e que a cada verificação e multiplicação com o valor do parâmetro num, terá o seu valor alterado para o resultado da multiplicação do seu valor anterior com o valor do parâmetro num
